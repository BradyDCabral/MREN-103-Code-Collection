/***************************************************
Group30Lab6LiftAndCurl (v1.2)

  Original by D. Ells 27/8/2021
  Revised by B. Surgenor, 25/04/2021
  Updated by B. Cabral & Emily Vargas-Penaranda, 15/02/2026

Lift, uncurl, curl and then lower the bucket once. Start with 
...
int servoPinB = 12;
int myAngleA1 = 140;    // initial angle, bucket lifts off ground if too high
int posA = myAngleA1;   // if set to 180, bucket lifts robot off of ground
int myAngleA2 = 85;     // highest angle (lift), puts almost straight, set to 110
                        //    still bent (i.e. not as high)
int myAngleB1 = 90; // good start
int posB = myAngleB1;
int myAngleB2 = 140; 
